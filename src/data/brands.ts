...
export const brands: BrandCaseStudy[] = [
  ...
  },
  {
    ...
    slug: "dr-nakul-ratra",
    name: "Dr. Nakul Ratra",
    tagline: "Restoring Character, Not Just Smiles",
    description: "Nakul's approach is grounded in the belief that beauty already exists within structure. His role is not to overwrite it — it is to bring it forward. With precision. With restraint. With artistry.",
    thumbnail: nakul01,
    challenge: "Dr. Ratra had a distinctive philosophy — preserve first, enhance second — but no brand infrastructure to communicate it. His identity didn't reflect the intentionality of his clinical approach or the calibre of patients he wanted to attract.",
    solution: "We built a brand rooted in warmth, restraint, and natural sophistication. The terracotta palette, handwritten 'Dr.' signature contrasted with structured serif typography, and earthy visual language all work together to communicate a dentist who designs smiles the way an artist works — layering, refining, revealing.",
    results: [
      "Complete brand identity system with dual wordmark and monogram",
      "Brand architecture connecting personal brand to Karma Dentistry",
      "Content system reflecting natural, intentional philosophy",
      "Visual language attracting patients who value preservation over perfection"
    ],
    services: ["Brand Strategy", "Visual Identity", "Wordmark Design", "Monogram Design", "Content Direction", "Social Templates"],
    timeline: "45-day build + ongoing management",
    examples: [
      { type: "image", label: "Brand Identity", src: nakul01 },
      { type: "image", label: "Billboard Mockup", src: nakul02 },
      { type: "image", label: "Brand Values", src: nakul03 },
      { type: "image", label: "Mobile Experience", src: nakul04 },
      { type: "image", label: "Brand Collateral", src: nakul05 },
      { type: "image", label: "Business Cards", src: nakul06 },
      { type: "image", label: "Content Campaign", src: nakul07 },
      { type: "image", label: "Wordmark Detail", src: nakul08 },
    ],
  },
  {
    id: 7,
    slug: "dr-meg-rascius",
    name: "Dr. Meg Rascius",
    tagline: "Timeless Artistry, Beautiful Smiles",
    description: "Just like an heirloom piece of jewelry, a healthy, happy smile becomes part of the moments we treasure most — shining bright and carrying stories of joy, confidence, and connection.",
    thumbnail: meg01,
    challenge: "Dr. Rascius needed a brand identity that matched her philosophy of gentle refinement — revealing natural brilliance rather than manufacturing it. The identity needed to feel warm, approachable, and unmistakably premium without tipping into clinical coldness.",
    solution: "Inspired by vintage jewelry pendants and timeless design, we crafted a brand system anchored by the MR monogram seal and a handwritten signature wordmark. The sage and blush palette, combined with serif typography, creates a sense of calm sophistication that invites patients to feel at ease from the very first glance.",
    results: [
      "Distinctive MR monogram seal inspired by vintage jewelry",
      "Complete clinic design integration with branded signage",
      "Brand system spanning digital, print, and environmental design",
      "Identity that feels enduring, graceful, and distinctly rooted in care"
    ],
    services: ["Brand Strategy", "Visual Identity", "Monogram Design", "Clinic Design", "Content Direction", "Collateral Design"],
    timeline: "45-day build + ongoing management",
    examples: [
      { type: "image", label: "Brand Identity", src: meg01 },
      { type: "image", label: "Logo Mark", src: meg02 },
      { type: "image", label: "Brand Seal", src: meg03 },
      { type: "image", label: "Wordmark System", src: meg04 },
      { type: "image", label: "Brand Campaign", src: meg05 },
      { type: "image", label: "Mobile Experience", src: meg06 },
      { type: "image", label: "Clinic Design", src: meg07 },
      { type: "image", label: "Brand Collateral", src: meg08 },
      { type: "image", label: "Brand System", src: meg09 },
    ],
  },
  {
    id: 8,
    ...
    tagline: "Cosmetic Dentistry That's Elevated",
    description: "The intention behind this project was clear: to establish a brand identity that captures Dr. Bateman's presence and translates it into a visual form — elevated, sophisticated, and instantly recognizable.",
    thumbnail: jake01,
    challenge: "Dr. Bateman needed a brand identity that projected the credibility of an experienced practitioner at the highest level. The identity needed to feel established and assured without leaning into excess — reflecting the same precision and artistry that define his clinical work.",
    solution: "The BATEMAN wordmark was crafted with minimalist elegance — its interplay of letter spacing and geometric detail conveys precision and authenticity. The JB monogram distills the brand into its purest form, creating a mark that is instantly recognizable yet understated. Together, the system embodies confidence, clarity, and refinement.",
    results: [
      "Distinctive BATEMAN wordmark with geometric precision",
      "JB monogram for versatile brand applications",
      "Complete environmental design for Brentwood, Tennessee practice",
      "Brand system projecting established authority and sophistication"
    ],
    services: ["Brand Strategy", "Visual Identity", "Wordmark Design", "Monogram Design", "Environmental Design", "Brand Collateral"],
    timeline: "45-day build + ongoing management",
    examples: [
      { type: "image", label: "Brand Identity", src: jake01 },
      { type: "image", label: "Wordmark System", src: jake02 },
      { type: "image", label: "Typography Grid", src: jake03 },
      { type: "image", label: "Storefront Signage", src: jake04 },
      { type: "image", label: "JB Monogram", src: jake05 },
      { type: "image", label: "Logo Mark Detail", src: jake06 },
      { type: "image", label: "Brand Campaign", src: jake07 },
      { type: "image", label: "Brand System", src: jake08 },
    ],
  },
];
