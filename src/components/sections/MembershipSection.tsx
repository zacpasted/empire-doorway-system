  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const { error } = await supabase.from("lead_magnet_submissions").insert({
        email,
        first_name: "Membership Waitlist",
      ...
      <div className="container max-w-3xl mx-auto px-4 relative z-10">
        ...
        >
          ...
          <p className="text-lg text-muted-foreground max-w-xl mx-auto mb-4 leading-relaxed">
            A private community and network for elite aesthetic dentists.
            Curated connections, exclusive insights, and the relationships
            that define the next chapter of the profession.
          </p>
