...
const cards = [
  { id: 1, image: smileTrend, name: 'Smile Trend' },
  { id: 2, image: drewBallard, name: 'Dr. Drew Ballard' },
  { id: 3, image: marshallHanson, name: 'Dr. Marshall Hanson' },
  { id: 4, image: alanClarke, name: 'Dr. Alan Clarke' },
  { id: 5, image: jonMarashi, name: 'Dr. Jon Marashi' },
  { id: 6, image: jakeBateman, name: 'Dr. Jake Bateman' },
  { id: 7, image: serenaWong, name: 'Dr. Serena Wong' },
  { id: 8, image: timHoeschen, name: 'Dr. Tim Hoeschen' },
  { id: 9, image: kooperRuminer, name: 'Dr. Kooper Ruminer' },
  { id: 10, image: navAtwal, name: 'Dr. Nav Atwal' },
];
    ...
    <section className="py-16 md:py-24 overflow-hidden">
      ...
      >
        {duplicatedCards.map((card, index) => (
          <div
            key={`${card.id}-${index}`}
            className="flex-shrink-0 w-[280px] md:w-[320px] transition-transform duration-300 hover:scale-[1.02]"
          >
            <img
              src={card.image}
              alt={card.name}
