...
const WhyPathsFailSection = () => {
  const paths = [
    {
      traditional: "Separate marketing agencies",
      result: "Fragmented strategy, no coordination",
      icon: AlertTriangle,
      effort: "$$$$/ month",
      outcome: "Disconnected results"
    },
    {
      traditional: "Freelance content creators",
      result: "No strategic direction behind the content",
      icon: TrendingDown,
      effort: "Ongoing management",
      outcome: "Content without conversion"
    },
    {
      traditional: "Lead generation companies",
      result: "Low-intent leads, price shoppers",
      icon: Zap,
      effort: "$$$$ ad spend",
      outcome: "Commoditized patients"
    },
    {
      traditional: "Template-based dental marketing",
      result: "Generic output that looks like everyone else",
      icon: X,
      effort: "Monthly retainers",
      outcome: "Zero differentiation"
    },
  ];
  ...
  const lineVariants = {
    ...
    visible: {
      scaleX: 1,
      transition: { duration: 0.8, ease: [0.25, 0.46, 0.45, 0.94] as const, delay: 0.5 }
    }
  };
  ...
  return (
    <section className="py-32 md:py-48 bg-card/30 relative overflow-hidden">
      ...
      <div className="container max-w-6xl mx-auto px-4 relative z-10">
        ...
        >
          Most cosmetic dentists try to grow through disconnected vendors, agencies, and freelancers.
          Here's why that approach consistently underperforms.
        </motion.p>
            ...
            return (
              ...
              >
                ...
                <div className="relative z-10">
                  ...
                  <h3 className="text-xl font-serif text-foreground mb-3">{path.traditional}</h3>
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <p className="text-muted-foreground">{path.result}</p>
                  </div>

                  <div className="mt-6 pt-4 border-t border-border/30">
                    <div className="flex items-center gap-2">
                      <span className="text-xs text-muted-foreground/50">Outcome:</span>
                      <span className="text-xs font-medium text-destructive/70">{path.outcome}</span>
                    </div>
                  </div>
                </div>
              </motion.div>
